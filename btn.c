...
#define BTN_ROW1_RD			GPIO_PORTF_BASE, GPIO_PIN_4 // SWT-GND1
#define BTN_ROW2_RD			GPIO_PORTD_BASE, GPIO_PIN_1 // SWT-GND2
#define BTN_ROW3_RD			GPIO_PORTD_BASE, GPIO_PIN_2 // SWT-GND3
#define BTN_ROW4_RD			GPIO_PORTD_BASE, GPIO_PIN_3 // SWT-GND4

#define BTN_COL1_IN			GPIO_PORTF_BASE, GPIO_PIN_0 // SWITCH1
#define BTN_COL2_IN			GPIO_PORTF_BASE, GPIO_PIN_1 // SWITCH2
#define BTN_COL3_IN			GPIO_PORTF_BASE, GPIO_PIN_2 // SWITCH3
#define BTN_COL4_IN			GPIO_PORTF_BASE, GPIO_PIN_3 // SWITCH4

#define LED_ROW1_RED		GPIO_PORTA_BASE, GPIO_PIN_6 // RED1
#define LED_ROW2_RED		GPIO_PORTB_BASE, GPIO_PIN_0 // RED2
#define LED_ROW3_RED		GPIO_PORTB_BASE, GPIO_PIN_2 // RED3
#define LED_ROW4_RED		GPIO_PORTC_BASE, GPIO_PIN_4 // RED4

#define LED_ROW1_BLUE		GPIO_PORTA_BASE, GPIO_PIN_7 // BLUE1
#define LED_ROW2_BLUE		GPIO_PORTB_BASE, GPIO_PIN_1 // BLUE2
#define LED_ROW3_BLUE		GPIO_PORTB_BASE, GPIO_PIN_3 // BLUE3
#define LED_ROW4_BLUE		GPIO_PORTC_BASE, GPIO_PIN_5 // BLUE4

#define LED_COL1_GND		GPIO_PORTC_BASE, GPIO_PIN_6 // LED-GND1
#define LED_COL2_GND		GPIO_PORTC_BASE, GPIO_PIN_7 // LED-GND2
#define LED_COL3_GND		GPIO_PORTD_BASE, GPIO_PIN_6 // LED-GND3
#define LED_COL4_GND		GPIO_PORTD_BASE, GPIO_PIN_7 // LED-GND4
