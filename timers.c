...
void FXIntHandler(void)
{
	...
	param1a = (float)(ulADC0_Value[0]/32);
	param1b = (float)(ulADC0_Value[1]/32);
	param2a = (float)(ulADC0_Value[2]/32);
	param2b = (float)(ulADC0_Value[3]/32);

	// pass these adc values into fx functions
//	process_FX(FX1mode, FX2mode, param1a, param1b, param2a, param2b);
